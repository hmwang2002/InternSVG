    ...
    def compute_SSIM(self, **kwargs):
        ...
        for frame1, frame2 in zip(frames1, frames2):
            ...
            if len(img1_np.shape) == 3 and img1_np.shape[2] == 3:
                ...
                cur_score, _ = ssim(img1_np, img2_np, win_size=win_size, channel_axis=channel_axis, sigma=sigma, full=True)
            else:
                ...
                cur_score, _ = ssim(img1_np, img2_np, win_size=win_size, sigma=sigma, full=True)
